...
var POW = 8 // world is a 2^POW sized, huge worlds eat a lot of cpu (8 or 9 works well) !!!!!!!!!!!!!!!!!!! 7 !!!!!!
var SCALE = 3 // draw each part as a SCALExSCALE rectangle !!!!!!!!!!!!!!!!!!! 3 !!!!!!!!!!
...
// constants
const MUTATION_RATE = 0.3// 0.01!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
const ENERGY_GENE_COST = 1 / 10 // 1/10
const START_LIFE = 1000 // alive for only 1000 ticks ~ 50 seconds @ 20 ticks per second ---- 1000
const START_ENERGY = 1.33 //1.33
const MAX_ENERGY = 3 // 3
const MAX_SEED_ENERGY = 3 // 3
const NEW_PART_COST = 1 // 1
const NEW_SEED_COST = 1.33
const START_FOOD = NEW_PART_COST * 0.8
const KILL_COST = 0.3

// per second constants
const GREEN_ENERGY_ADD = 0.75 // 0.75
